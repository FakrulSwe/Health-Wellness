		...
		<div class="chome"> 
			...
			<div class="cus-bottom" style="margin-top: 5%"> 
				<div class="container" style="padding-bottom:150px;"> 
					...
					<div class="img col-md-3" style="margin: 2%;background-color: #e3e8ef;border: 1px #e3e8ef;border-radius: 5%; opacity:0.6;filter: alpha(opacity=60);text-align: center;margin-left: 5%;padding-top: 2%;padding-bottom: 2%;box-shadow: 5px 10px #989ba0;margin-top: 4%"><a href="cusfindAmbulance.php"><img src="img/ambulance.png" alt=""  style="max-height: 70%;max-width: 70%"></a>
					<br>
                    <br>
