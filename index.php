			...
			<div class="container"> 
				...
				<div class="menu col-md-7"> 
					<ul class="list-unstyled list-inline pull-right">
						...
						<li><a href="Ambulsignup.php" style="color:white;">Ambulance Signup</a></li>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="images/19.gif" alt="Los Angeles" style="width:100%;">
      ...
      <div class="item">
        <img src="images/Medicine.gif" alt="Chicago" style="width:100%;">
          <div class="carousel-caption">
      ...
      <div class="item">
        <img src="images/23.gif" alt="New york" style="width:100%;">
          <div class="carousel-caption">
...
<div class="parts container row" style="margin-top:30px;padding-bottom:30px; background:#EAEAEAE6;width: 101%;"> 
    ...
    <div class="container row" style="width: 103%; background: #1a1a1ae6; margin-top: -30px;"> 
				<div class="col-md-12 text-center" style="margin-top:30px;padding-bottom:20px;"> 
                    ...
                    <p style="font-weight: bold; font-size: 15px;color: white;">Designed by Fohrul Islam & Mahmuda Akter Lubna</p>
				</div>
